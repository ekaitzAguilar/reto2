...
public class GestorHabitacionTipo {
	...
	public GestorHabitacionTipo(ArrayList<JPanel> paneles) {
		...
		comboBox.setBounds(309, 171, 151, 27);
		gestorEventoTipo.add(comboBox);

		JComboBox tipoHab = new JComboBox();
		tipoHab.addActionListener(new ActionListener() {
		...
		tipoHab.setModel(new DefaultComboBoxModel(new String[] { "Seleccionar...", "VUELO", "ALOJAMIENTO", "ACTIVIDAD" }));
		tipoHab.setBounds(309, 116, 151, 27);
		gestorEventoTipo.add(tipoHab);
